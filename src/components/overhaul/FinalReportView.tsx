...
export default function FinalReportView() {
  ...
  const report = useMemo(() => buildReport(scope, values, extracts), [scope, values, extracts]);
...
function buildReport(scope: Scope, values: Values, extracts: Extraction[]) {
